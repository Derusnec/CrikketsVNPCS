...
ENT.PrintName = "GLaDOS" -- This will be the printed name of your bot.
...
--BASIC MODEL INFO
ENT.Models = {"models/meercat/glados_humanoid_rw22/glados_humanoid_rw22.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
ENT.WalkSpeed = 56 --The bot's walking speed, or idle speed.
...
--}
ENT.OnIdleSounds = {
    "vo/glados/anti_taunt09.wav",
    "vo/glados/anti_taunt10.wav",
    "vo/glados/anti_taunt14.wav",
    "vo/glados/anti_taunt15.wav",
    "vo/glados/coop_laugh01.wav",
    "vo/glados/dlc1_leaderboard08.wav",
    "vo/glados/dlc1_leaderboard09.wav",
    "vo/glados/dlc1_leaderboard14.wav",
    "vo/glados/dlc1_leaderboard24.wav",
    "vo/glados/dlc1_mp_coop_art_death_acid04.wav",
    "vo/glados/fgb_trap03.wav",
    "vo/glados/fgbrvtrap02.wav",
    "vo/glados/mp_coop_humanresourcedeath01.wav",
    "vo/glados/mp_coop_humanresourcedeath02.wav",
    "vo/glados/mp_coop_humanresourcedeath03.wav",
    "vo/glados/mp_coop_obstacle01.wav",
    "vo/glados/mp_coop_startdeath02.wav",
    "vo/glados/mp_death05.wav",
    "vo/glados/mp_death08.wav",
    "vo/glados/mp_taunts03.wav",
    "vo/glados/mp_taunts04.wav",
    "vo/glados/taunt_big_wave02.wav",
    "vo/glados/taunt_big_wave05.wav",
    "vo/glados/taunt_cannonball03.wav",
    "vo/glados/mp_taunts04.wav",
	"vo/glados/testchambermisc24.wav",
	"vo/glados/testchambermisc41.wav"
}
ENT.IdleSoundDelay = math.random(8,24) --Needs a better system as it only sets the random number on spawn.
ENT.ClientIdleSounds = false
ENT.DamageSoundDelay = 12 --Delay between the sounds of V-NPC taking damage, recommended to be kinda high to prevent spam.
ENT.OnDamageSounds = {
    "vo/glados/dlc1_leaderboard01.wav",
    "vo/glados/mp_death01.wav",
    "vo/glados/mp_death12.wav",
    "vo/glados/mp_death17.wav",
    "vo/glados/mp_death19.wav",
    "vo/glados/mp_death26.wav",
	"vo/glados/taunt_laugh01.wav",
	"vo/glados/taunt_laugh02.wav"
}
ENT.OnDeathSounds = {
    "vo/glados/anti_taunt23.wav",
    "vo/glados/sp_sabotage_glados_gibberish01.wav",
    "vo/glados/sp_sabotage_glados_gibberish03.wav",
    "vo/glados/sp_sabotage_glados_gibberish04.wav",
    "vo/glados/sp_sabotage_glados_gibberish05.wav",
    "vo/glados/sp_sabotage_glados_gibberish06.wav",
	"vo/glados/sp_sabotage_glados_gibberish07.wav"
}

--VORE SOUNDS, ONLY USE THIS IF YOU WANT YOUR OWN CUSTOM SOUNDS!
ENT.VoreBurpSounds = { --this is only 'human' sounds, belly sounds are different
	["big_burp"] = {
		"ambient/machines/steam_release_2.wav",
	},
	["small_burp"] = {
...
ENT.VoreSoundPitch = 0.8 --The pitch of the vore sounds above, also default sounds.

ENT.Footsteps = { --Footstep sounds! Defaults to barefoot steps I added.
    ["Default"] = {
        "player/footsteps/coop_bot_ball_fs_robotics_impact_01.wav",
        "player/footsteps/coop_bot_ball_fs_robotics_impact_02.wav",
        "player/footsteps/coop_bot_ball_fs_robotics_impact_03.wav",
        "player/footsteps/coop_bot_ball_fs_robotics_impact_04.wav",
        "player/footsteps/coop_bot_ball_fs_robotics_impact_05.wav"
    },
}
function ENT:EmitFootstep()
    if not self.Footsteps or not self.Footsteps["Default"] then return end
    self:EmitSound(table.Random(self.Footsteps["Default"]), 70, 70)
end
...
ENT.Belly_Angles = Angle(0, 105, 90) --The rotation of the gut!
...
ENT.BellyProperties = {
	...
	DigestionStrength = 10, --Digestion: 2 = weak, 4 = normal, 6 = athletic, 8 = predator, 10 = apex, 12 = instant
	...
	BellyMaterial = "models/wormonlooker/belly/belly_glados", --Use this to set custom belly materials. Check out the materials folder!
}
