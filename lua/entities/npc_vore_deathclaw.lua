...
ENT.PrintName = "Deathclaw" -- This will be the printed name of your bot.
...
ENT.SightFOV = 110 --This is our field of view for the V-NPC
...
ENT.JumpHeight = 96 --Jump height! Recommended to leave as is.
...
function ENT:EmitFootstep()
    ...
    self:EmitSound(table.Random(self.Footsteps["Default"]), 90, 100)
end
