...
ENT.PrintName = "Karelia" -- This will be the printed name of your bot.
ENT.Category = "Crikket's V-NPC" -- This is the category your bot is in, Vore is the generic one.
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3647700399" -- This is where you'll put the steam workshop ID for your V-NPC model.

--BASIC MODEL INFO
ENT.Models = {"models/ltusamodels_inc/karelia_cryptia/karelia_player_1.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
ENT.RunAnimation = ACT_HL2MP_WALK_MAGIC
ENT.AttackAnimation = "gesture_becon_original" --attack animation, beckon is pretty solid for a faux-swallow motion.
ENT.MeleeAttackRange = 192 --attack range
ENT.ReachEnemyRange = 144 --when do we try actually attacking?
...
ENT.OnIdleSounds = {
    "ambient/levels/caves/rumble1.wav",
	"ambient/levels/caves/dist_growl1.wav",
	"ambient/levels/caves/dist_growl2.wav",
	"ambient/levels/caves/dist_growl4.wav"
}
ENT.Footsteps = {
    ["Default"] = {
        "belly/barestep1.wav",
...
--VORE BELLY VISUALS
ENT.BellyColor = Color(38, 37, 38) --gut color, debug starts white.
...
ENT.VoreSettings.FatFoldsMaxSize = 0.3 --you can set this to zero to not have fat folds, or 1 for an obese mf.

--DIGESTION SETTINGS
ENT.VoreSettings.DigestionStrength = 12 --Digestion: 2 = weak, 4 = normal, 6 = athletic, 8 = predator, 10 = apex, 12 = instant
...
ENT.VoreSettings.WeightGainBones = {
    ...
    "ValveBiped.Bip01_Spine1",
		...
		"Butt1.L",
		"Butt.R",
		"Butt1.R", --No need to remove end commas on this table.
}
...
local AnimatedBoneList = {
	...
	["ValveBiped.Bip01_L_UpperArm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-30.000, 0.000, -10.000)
	},
	["ValveBiped.Bip01_L_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -10.000, 30.000)
	},
	...
	["ValveBiped.Bip01_R_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(12.719, -15.906, 12.719)
	},
	["Earring.R"] = {
		pos = Vector(0.000, -0.500, 1.500),
		ang = Angle(0.000, 0.000, 0.000)
	...
	["ValveBiped.Bip01_R_Finger1"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(15.906, 19.094, 0.000)
	},
	["ValveBiped.Bip01_R_Finger0"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -28.656, 25.469)
	},
	...
	["ValveBiped.Bip01_L_Thigh"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-5.000, 15.000, 0.000)
	},
	["ValveBiped.Bip01_R_Thigh"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(15.000, 15.000, 0.000)
	},
	["ValveBiped.Bip01_Spine"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -5.000, 0.000)
	...
	["ValveBiped.Bip01_L_UpperArm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-38.219, -31.844, -9.969)
	},
	["ValveBiped.Bip01_L_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-31.844, -3.156, 12.719)
	},
	["ValveBiped.Bip01_R_Clavicle"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-0.000, -0.000, 0.000)
	...
	["Breast.R"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(3.156, 19.094, 0.000)
	},
	["Breast1.R"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(25.469, 15.906, -6.344)
	},
	["Breast.L"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(12.719, 12.719, -6.344)
	},
	["Breast1.L"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-25.469, 15.906, 0.000)
	},
	["Tail"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, 0.000, -12.719)
