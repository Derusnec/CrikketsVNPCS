...
ENT.PrintName = "Akky (Maid)" -- This will be the printed name of your bot.
...
--BASIC MODEL INFO
ENT.Models = {"models/kapuyas/kemono/akky/mari_akky5_pm.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
--}
ENT.OnIdleSounds = {
    "belly/akky_idle_1.wav",
    "belly/akky_idle_2.wav",
    "belly/akky_idle_3.wav",
    "belly/akky_idle_4.wav",
    "belly/akky_idle_5.wav",
    "belly/akky_idle_6.wav",
    "belly/akky_idle_7.wav",
    "belly/akky_idle_8.wav",
    "belly/akky_idle_9.wav"
}
...
function ENT:EmitFootstep()
    ...
    self:EmitSound(table.Random(self.Footsteps["Default"]), 60, 100)
end
...
--BELLY VISUALS/SETUP
ENT.Belly_Offset = Vector(8, 4, 0) --gut offset from pelvis, change this!
...
--BELLY PROPERTIES
ENT.BellyProperties = {
	BellyColor = Color(231, 231, 231), --< Replaces color of belly, uses RGB 
