...
ENT.PrintName = "Toofy" -- This will be the printed name of your bot.
ENT.Category = "Crikket's V-NPC" -- This is the category your bot is in, Vore is the generic one.
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3587767878" -- This is where you'll put the steam workshop ID for your V-NPC model.

--BASIC MODEL INFO
ENT.Models = {"models/alvaroports/toofyratpm.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
ENT.WalkSpeed = 192 --The bot's walking speed, or idle speed.
...
ENT.MeleeAttackRange = 56 -- +16 enemy range. So 64, 72, 80, 88, 108 respectively
...
ENT.IdleSoundDelay = math.random(4,16)
...
--VORE BELLY VISUALS
ENT.BellyColor = Color(248, 217, 197) --gut color, debug starts white.
ENT.Belly_Offset = Vector(3, 6, 0) --gut offset from pelvis, change this!
ENT.BellyMaterial = "models/wormonlooker/belly/belly_toofy" --Use this to set custom belly materials. Check out the materials folder!
...
ENT.VoreSettings.WeightGainBones = {
    ...
    "ValveBiped.Bip01_Spine1",
        ...
        "DEF-Testicle.R",
        "DEF-Testicle.001.R",
        "DEF-Testicle.002.R", --No need to remove end commas on this table.
}
