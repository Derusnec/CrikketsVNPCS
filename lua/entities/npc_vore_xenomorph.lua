...
ENT.PrintName = "Xenomorph Queen" -- This will be the printed name of your bot.
ENT.Category = "Crikket's V-NPC" -- This is the category your bot is in, Vore is the generic one.
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3646925185" -- This is where you'll put the steam workshop ID for your V-NPC model.

--BASIC MODEL INFO
ENT.Models = {"models/alvaroports/alienqueenpm.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
ENT.SightFOV = 140 --This is our field of view for the V-NPC
...
ENT.OnSpawnSounds = {
    "belly/xenomorph_spawn.wav"
}
ENT.OnIdleSounds = {
    "belly/xenomorph_idle_1.wav",
    "belly/xenomorph_idle_2.wav",
    "belly/xenomorph_idle_3.wav",
    "belly/xenomorph_idle_4.wav",
    "belly/xenomorph_idle_5.wav"
}
ENT.IdleSoundDelay = math.random(6,24)
...
function ENT:EmitFootstep()
    ...
    self:EmitSound(table.Random(self.Footsteps["Default"]), 90, 90)
end
...
ENT.Belly_Offset = Vector(0, 2, 1) --gut offset from pelvis, change this!
ENT.Belly_Angles = Angle(-10, 85, 80) --The rotation of the gut!
...
ENT.VoreSettings.WeightGainBones = {
    ...
    "ValveBiped.Bip01_Spine1",
		...
		"Butt.L",
		"Butt.R", --No need to remove end commas on this table.
}
...
local AnimatedBoneList = {
	...
	["ValveBiped.Bip01_L_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-20.000, 80.000, -25.000)
	},
	...
	["ValveBiped.Bip01_R_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(45.000, 45.000, 10.000)
	},
	["Tail"] = {
		pos = Vector(0.000, 0.000, 0.000),
	...
	["ValveBiped.Bip01_L_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, 35.031, -25.469)
	},
	["ValveBiped.Bip01_R_Clavicle"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(3.156, 25.469, 0.000)
	},
	["ValveBiped.Bip01_R_UpperArm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-3.156, -6.344, 0.000)
	},
	["ValveBiped.Bip01_R_Forearm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -41.406, -6.344)
	},
	["ValveBiped.Bip01_R_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(45.000, 45.000, 10.000)
