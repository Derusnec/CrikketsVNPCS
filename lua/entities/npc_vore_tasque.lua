...
ENT.PrintName = "Tasque Manager" -- This will be the printed name of your bot.
ENT.Category = "Crikket's V-NPC" -- This is the category your bot is in, Vore is the generic one.
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3646929959" -- This is where you'll put the steam workshop ID for your V-NPC model.

--BASIC MODEL INFO
ENT.Models = {"models/ltusamodels_inc/s_tm_cryptia/s_tm_player.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
--}
ENT.OnIdleSounds = {
    "belly/tasque_idle_1.wav",
    "belly/tasque_idle_2.wav",
    "belly/tasque_idle_3.wav",
    "belly/tasque_idle_4.wav"
}
ENT.IdleSoundDelay = math.random(8,16)
...
function ENT:EmitFootstep()
    ...
    self:EmitSound(table.Random(self.Footsteps["Default"]), 65, 110)
end
ENT.VoreSoundPitch = 1.4
--AI VORE MECHANICS
ENT.VoreSettings = {}
...
--VORE BELLY VISUALS
ENT.BellyColor = Color(22, 36, 52) --gut color, debug starts white.
ENT.Belly_Offset = Vector(-3, 0, 0) --gut offset from pelvis, change this!
ENT.BellyMaterial = "models/wormonlooker/belly/belly_tasque" --Use this to set custom belly materials. Check out the materials folder!
...
ENT.VoreSettings.WeightGainBones = {
    ...
    "ValveBiped.Bip01_Spine1",
		...
		"ThighJiggleTop.L",
		"ThighJiggleBottom.R",
		"ThighJiggleTop.R", --No need to remove end commas on this table.
}
...
local AnimatedBoneList = {
	[0] = { --IDLE POSE
	["ValveBiped.Bip01_Pelvis"] = {
		pos = Vector(0.000, 0.000, 5.000),
		ang = Angle(0.000, 0.000, -10.000)
	},
	["ValveBiped.Bip01_L_Thigh"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-5.000, 20.000, 10.000)
	},
	...
	["ValveBiped.Bip01_L_Clavicle"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(5.000, 20.000, 5.000)
	},
	["ValveBiped.Bip01_L_UpperArm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-10.000, 10.000, -15.000)
	},
	["ValveBiped.Bip01_L_Forearm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(10.000, -5.000, 40.000)
	},
	...
	["ValveBiped.Bip01_R_UpperArm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(10.000, 15.000, 15.000)
	},
	...
	["ValveBiped.Bip01_L_Finger4"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(15.000, -20.000, 25.000)
	},
	...
	["ValveBiped.Bip01_Pelvis"] = {
		pos = Vector(0.000, 0.000, 6.000),
		ang = Angle(0.000, 0.000, -10.000)
	},
	["ValveBiped.Bip01_L_Thigh"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-4.969, 15.000, 9.969)
	},
	["ValveBiped.Bip01_L_Foot"] = {
		pos = Vector(0.000, 0.000, 0.000),
	...
	["ValveBiped.Bip01_L_Clavicle"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(5.000, 19.999, 5.000)
	},
	["ValveBiped.Bip01_L_UpperArm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-9.999, 9.999, -14.999)
	},
	["ValveBiped.Bip01_L_Forearm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(9.999, -5.000, 39.998)
	},
	["ValveBiped.Bip01_L_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-9.999, -5.000, 14.999)
	},
	["ValveBiped.Bip01_R_Clavicle"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-5.000, 19.999, -5.000)
	...
	["ValveBiped.Bip01_L_Finger2"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -9.999, 0.000)
	},
	["ValveBiped.Bip01_L_Finger21"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -14.999, 0.000)
	},
	["ValveBiped.Bip01_L_Finger22"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -14.999, 0.000)
	...
	["ValveBiped.Bip01_L_Finger4"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(14.999, -19.999, 24.998)
	},
	["ValveBiped.Bip01_L_Finger41"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -44.997, 0.000)
	},
	["ValveBiped.Bip01_L_Finger42"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -44.997, 0.000)
	...
	["ValveBiped.Bip01_L_Finger3"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(9.999, -14.999, 0.000)
	},
	["ValveBiped.Bip01_L_Finger31"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -29.998, 0.000)
	},
	["ValveBiped.Bip01_L_Finger32"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -29.998, 0.000)
	...
	[3] = { --BELCHING POSE
	["ValveBiped.Bip01_Pelvis"] = {
		pos = Vector(0.000, 0.000, 4.993),
		ang = Angle(0.000, 0.000, -9.985)
	},
	["ValveBiped.Bip01_L_Thigh"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-4.993, 19.971, 9.985)
	},
	["ValveBiped.Bip01_L_Foot"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -9.985, 0.000)
	},
	["ValveBiped.Bip01_R_Thigh"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(4.993, -4.993, -9.985)
	},
	["ValveBiped.Bip01_R_Foot"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, 15.977, 0.000)
	},
	["ValveBiped.Bip01_Spine"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, 10.000, 0.000)
	...
	["ValveBiped.Bip01_L_Clavicle"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-5.000, 15.000, 6.000)
	},
	["ValveBiped.Bip01_L_UpperArm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-9.985, 9.985, -14.978)
	},
	["ValveBiped.Bip01_L_Forearm"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(9.985, -4.993, 39.942)
	},
	["ValveBiped.Bip01_L_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(10.000, 30.000, 10.000)
	},
	["ValveBiped.Bip01_R_Clavicle"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-5.000, 15.000, -6.000)
	...
	["ValveBiped.Bip01_L_Finger0"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -19.971, 0.000)
	},
	["ValveBiped.Bip01_L_Finger01"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, 4.993, 0.000)
	},
	["ValveBiped.Bip01_L_Finger02"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, 14.978, 0.000)
	...
	["ValveBiped.Bip01_L_Finger4"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(14.978, -19.971, 24.963)
	},
	["ValveBiped.Bip01_L_Finger41"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -44.934, 0.000)
	},
	["ValveBiped.Bip01_L_Finger42"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -44.934, 0.000)
	...
	["ValveBiped.Bip01_L_Finger3"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(9.985, -14.978, 0.000)
	},
	["ValveBiped.Bip01_L_Finger31"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -29.956, 0.000)
	},
	["ValveBiped.Bip01_L_Finger32"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -29.956, 0.000)
