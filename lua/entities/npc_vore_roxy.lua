...
ENT.PrintName = "Roxy" -- This will be the printed name of your bot.
ENT.Category = "Crikket's V-NPC" -- This is the category your bot is in, Vore is the generic one.
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3204743720" -- This is where you'll put the steam workshop ID for your V-NPC model.

--BASIC MODEL INFO
ENT.Models = {"models/alvaroports/roxypm.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
ENT.JumpHeight = 384 --Jump height! Recommended to leave as is.
...
ENT.OnIdleSounds = {
    "ambient/animal/dog_med_inside_bark_1.wav",
    "ambient/animal/dog_med_inside_bark_2.wav",
    "ambient/animal/dog_med_inside_bark_3.wav",
    "ambient/animal/dog_med_inside_bark_4.wav",
    "ambient/animal/dog_med_inside_bark_5.wav",
    "ambient/animal/dog_med_inside_bark_6.wav",
    "ambient/animal/dog_med_inside_growl_1.wav",
    "ambient/animal/dog_med_inside_growl_2.wav"
}
...
function ENT:EmitFootstep()
    ...
    self:EmitSound(table.Random(self.Footsteps["Default"]), 65, 90)
end
...
--VORE BELLY VISUALS
ENT.BellyColor = Color(235, 236, 235) --gut color, debug starts white.
ENT.Belly_Offset = Vector(0, 5, 0) --gut offset from pelvis, change this!
ENT.BellyMaterial = "models/wormonlooker/belly/belly_roxy" --Use this to set custom belly materials. Check out the materials folder!
