...
ENT.PrintName = "Akky" -- This will be the printed name of your bot.
...
--BASIC MODEL INFO
ENT.Models = {"models/kapuyas/kemono/akky/mari_akky3_pm.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
