...
ENT.PrintName = "PUR-03" -- This will be the printed name of your bot.
ENT.Category = "Crikket's V-NPC" -- This is the category your bot is in, Vore is the generic one.
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3638168031" -- This is where you'll put the steam workshop ID for your V-NPC model.

--BASIC MODEL INFO
ENT.Models = {"models/boboxmanmissions/fuch/pur03.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
--ANIMATION BEHAVIOR
ENT.IdleAnimation = ACT_HL2MP_IDLE_CROUCH_ZOMBIE --Check out https://wiki.facepunch.com/gmod/Enums/ACT for HL2MP activities (the rest generally dont work but experiment with your specific models.)
ENT.WalkAnimation = ACT_HL2MP_WALK_CROUCH_KNIFE --Check out https://wiki.facepunch.com/gmod/Enums/ACT for HL2MP activities (the rest generally dont work but experiment with your specific models.)
ENT.RunAnimation = ACT_HL2MP_RUN_KNIFE --Check out https://wiki.facepunch.com/gmod/Enums/ACT for HL2MP activities (the rest generally dont work but experiment with your specific models.)
...
--}
ENT.OnIdleSounds = {
    "belly/pur03_idle_1.wav",
    "belly/pur03_idle_2.wav",
    "belly/pur03_idle_3.wav",
    "belly/pur03_idle_4.wav",
    "belly/pur03_idle_5.wav",
    "belly/pur03_idle_6.wav",
    "belly/pur03_idle_7.wav",
    "belly/pur03_idle_8.wav",
    "belly/pur03_idle_9.wav"
}
ENT.IdleSoundDelay = math.random(6,12) --Needs a better system as it only sets the random number on spawn.
ENT.ClientIdleSounds = false
--ENT.DamageSoundDelay = 4 --Delay between the sounds of V-NPC taking damage, recommended to be kinda high to prevent spam.
--ENT.OnDamageSounds = {
--    "belly/akky_hurt_1.wav",
--    "belly/akky_hurt_2.wav",
--    "belly/akky_hurt_3.wav",
--    "belly/akky_hurt_4.wav"
--}
--ENT.OnDeathSounds = {
--    "belly/akky_death_1.wav",
--    "belly/akky_death_2.wav"
--}
...
function ENT:EmitFootstep()
    ...
    self:EmitSound(table.Random(self.Footsteps["Default"]), 60, 110)
end
...
--BELLY VISUALS/SETUP
ENT.Belly_Offset = Vector(1, 3, 0) --gut offset from pelvis, change this!
ENT.Belly_Angles = Angle(0, 70, 90) --The rotation of the gut!
...
--BELLY PROPERTIES
ENT.BellyProperties = {
	BellyColor = Color(91, 92, 99), --< Replaces color of belly, uses RGB 
	...
	BellyMaterial = "models/wormonlooker/belly/belly_pur03", --Use this to set custom belly materials. Check out the materials folder!
}
