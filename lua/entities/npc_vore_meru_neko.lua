...
function ENT:EmitFootstep()
    ...
    self:EmitSound(table.Random(self.Footsteps["Default"]), 40, 105)
end
...
ENT.Belly_Offset = Vector(-3, 4, -0.5) --gut offset from pelvis
ENT.Belly_Angles = Angle(10, 85, 95) --The rotation of the gut!
