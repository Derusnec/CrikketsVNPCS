...
ENT.PrintName = "Albino Deathclaw" -- This will be the printed name of your bot.
ENT.Category = "Crikket's V-NPC" -- This is the category your bot is in, Vore is the generic one.
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3656723293" -- This is where you'll put the steam workshop ID for your V-NPC model.

--BASIC MODEL INFO
ENT.Models = {"models/alvaroports/deathclawpm.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
ENT.ModelScale = 2 --scale of initial model, be careful with this!
...
ENT.ClimbLedgesMaxHeight = 512 --How high can we climb? Be careful with this.
...
ENT.OnIdleSounds = {
    "belly/npc_deathclaw_idle_01.wav",
    "belly/npc_deathclaw_idle_02.wav",
    "belly/npc_deathclaw_idle_03.wav",
	"belly/npc_deathclaw_idle_04.wav",
	"belly/npc_deathclaw_idle_teethpick.wav"
}
ENT.Footsteps = {
    ["Default"] = {
        "belly/npc_deathclaw_foot_l_01.wav",
        "belly/npc_deathclaw_foot_l_01.wav",
        "belly/npc_deathclaw_foot_r_01.wav",
        "belly/npc_deathclaw_foot_r_02.wav"
    },
}
function ENT:EmitFootstep()
    if not self.Footsteps or not self.Footsteps["Default"] then return end
    self:EmitSound(table.Random(self.Footsteps["Default"]), 100, 80)
end
...
--VORE BELLY VISUALS
ENT.BellyColor = Color(255, 238, 236) --gut color, debug starts white.
ENT.Belly_Offset = Vector(6, 6, -1.5) --gut offset from pelvis, change this!
ENT.Belly_Angles = Angle(6, 100, 90) --The rotation of the gut!
ENT.BellyMaterial = "models/wormonlooker/belly/belly_deathclaw_r" --Use this to set custom belly materials. Check out the materials folder!
ENT.VoreSettings.MaxBaseSize = 0 --any leftover chub? 1 = full belly 0 = flat belly
ENT.VoreSettings.BellyFloorModifier = 0.1 --how low/high belly will be angled to avoid floor clipping. The higher the value, the more elevated.
...
local AnimatedBoneList = {
	...
	["ValveBiped.Bip01_Pelvis"] = {
		...
		ang = Angle(0.000, 0.000, 12.000)
	},
	["ValveBiped.Bip01_L_Thigh"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-6.000, -6.000, 0.000)
	},
	["ValveBiped.Bip01_L_Calf"] = {
		pos = Vector(0.000, 0.000, 0.000),
	...
	["ValveBiped.Bip01_R_Hand"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(25.000, -20.000, 60.000)
	},
	["ValveBiped.Bip01_R_Finger11"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, -40.000, 0.000)
