...
ENT.PrintName = "SCP-1471" -- This will be the printed name of your bot.
ENT.Category = "Crikket's V-NPC" -- This is the category your bot is in, Vore is the generic one.
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3586643856" -- This is where you'll put the steam workshop ID for your V-NPC model.

--BASIC MODEL INFO
ENT.Models = {"models/alvaroports/mal0danilkazpm.mdl"} -- Insert the V-NPC model's path here. You can copy it in Gmod.
...
ENT.ModelScale = 1.3 --scale of initial model, be careful with this!
...
ENT.SpotDuration = 120 --How long do we pursue prey we see?
...
ENT.OnIdleSounds = {
    "ambient/animal/dog_pant_behind_wall_1.wav",
	"ambient/animal/dog_pant_behind_wall_2.wav",
    "ambient/animal/dog_scratch_behind_wall_1.wav",
	"ambient/animal/dog_lick_chops_behind_wall_1.wav"
}
ENT.Footsteps = {
    ["Default"] = {
        "belly/barestep1.wav",
...
function ENT:EmitFootstep()
    ...
    self:EmitSound(table.Random(self.Footsteps["Default"]), 70, 75)
end
...
--VORE BELLY VISUALS
ENT.BellyColor = Color(37, 36, 45) --gut color, debug starts white.
ENT.Belly_Offset = Vector(2, 5, 0) --gut offset from pelvis, change this!
ENT.BellyMaterial = "models/wormonlooker/belly/belly_mal0" --Use this to set custom belly materials. Check out the materials folder!
ENT.VoreSettings.MaxBaseSize = 0.5 --any leftover chub? 1 = full belly 0 = flat belly
...
ENT.VoreSettings.WeightGainBones = {
    ...
    "ValveBiped.Bip01_Spine1",
		...
		"DEF-Butt1.R.001",
		"DEF-Butt1.R", --No need to remove end commas on this table.
}
...
local AnimatedBoneList = {
	...
	["ValveBiped.Bip01_Head1"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(-4.342, -17.325, -22.554)
	},
	["DEF-jaw"] = {
		pos = Vector(0.000, 0.000, 0.000),
		ang = Angle(0.000, 0.000, -3.000)
	},
