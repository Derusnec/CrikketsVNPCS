...
ENT.PrintName = "TEMPORARY" -- This will be the printed name of your bot.
ENT.Category = "Vore" -- This is the category your bot is in, Vore is the generic one.
...
--DIGESTION SETTINGS
ENT.VoreSettings.DigestionStrength = 0 --Digestion: 2 = weak, 4 = normal, 6 = athletic, 8 = predator, 10 = apex, 12 = instant
